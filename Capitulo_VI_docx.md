...
![Figura 6.1. Diagrama general de casos de uso.](Capitulo_VI_diagramas/6.10.1_casos_uso.png){width=15.0cm}
...
![Figura 6.2. Diagrama de componentes (arquitectura modular / SOA).](Capitulo_VI_diagramas/6.10.6_componentes.png){width=15.0cm}
...
![Figura 6.3. Diagrama de despliegue.](Capitulo_VI_diagramas/6.10.8_despliegue.png){width=15.0cm}
...
![Figura 6.4. Diagrama de clases del sistema.](Capitulo_VI_diagramas/6.10.5_clases.png){width=14.4cm}
...
![Figura 6.5. Diagrama de actividad — ciclo general de la simulación.](Capitulo_VI_diagramas/6.10.2_actividad_ciclo.png){width=15.0cm}
...
![Figura 6.6. Diagrama de secuencia — iniciar simulación.](Capitulo_VI_diagramas/6.10.3_secuencia_iniciar.png){width=15.0cm}
...
![Figura 6.7. Diagrama de secuencia — pérdida de comunicación simulada.](Capitulo_VI_diagramas/6.10.4_secuencia_perdida_comunicacion.png){width=15.0cm}
...
![Figura 6.8. Diagrama de estados de una unidad simulada.](Capitulo_VI_diagramas/6.10.7_estados_unidad.png){width=15.0cm}
